...
const VideoContainer = styled.div`
  ...
  position: relative;
  background-image: url("/images/watchinglive/baseball.png");
  ...
  > .middle {
    ...
    > .middle {
      ...
      div {
        ...
        text-align: center;
        color: #fff;
        margin-bottom: calc((9 / 720) * 100vw);
      }
      span {
        object-fit: contain;
        opacity: 0.5;
...
const ScoreTbody = styled.tbody`
  .image {
    background-image: ${(props) => "url(" + props.item?.logo + ")"};
    background-size: calc((16 / 720) * 100vw) auto;
    background-position: center;
    background-repeat: no-repeat;
  }
  .home {
...
const LiveBaseballMobile = ({ setMobileMenu, mobileMenu }) => {
  ...
  const tmpList = [
    {
      type: "head",
      score: [1, 2, 3, 4, 5, 6, 7, 8, 9, "연장"],
    },
    {
      logo: "/images/main/KansasCity.png",
      name: "메이크도니자 GP",
      score: [1, 2, 0, 0, 5, 1, 0, 0, 0, 1],
      activeScore: 5,
    },
    {
      logo: "/images/main/KansasCity.png",
...
export default LiveBaseballMobile;
