...
const LiveTennisMobile = ({ setMobileMenu, mobileMenu }) => {
      ...
      <InfoContainer>
        <div className="bottom">
          <div className="top">
            ...
            <div>
              <span>2</span>
              <span className="text">더블 폴트</span>
            </div>
            <VerticalBar />
            <div>
              <span>3</span>
          ...
          <div className="info">
            <div>
              ...
              <div className="title">브포 전환율</div>
            ...
            <div>
              ...
              <div className="title">서브 포인트 획득</div>
              <InfoBar type="right" width="49%">
                <div></div>
              </InfoBar>
              <div>48</div>
...
export default LiveTennisMobile;
