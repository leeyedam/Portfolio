        ...
        <VideoContainer fullScreen={fullScreen}>
          {(multiView.text === "2멀티화면" ||
            ...
            <>
              ...
              <VideoViewContainer>
                <VideoView background="/images/main/Highlight2.png"></VideoView>
                <VideoViewInfo>
                  <VideoViewOption>
                    <span>알 메사이미어</span>
                    <img src="/images/live/Team4.png" alt=""></img>
              ...
              {multiView.text === "4멀티화면" && (
                <>
                  <VideoViewContainer>
                    <VideoView background="/images/main/Highlight4.png"></VideoView>
                    <VideoViewInfo>
                      <VideoViewOption>
                        <span>알 메사이미어</span>
                        <img src="/images/live/Team4.png" alt=""></img>
                  ...
                  <VideoViewContainer>
                    <VideoView background="/images/main/Highlight1.png"></VideoView>
                    <VideoViewInfo>
                      <VideoViewOption>
                        <span>알 메사이미어</span>
                        <img src="/images/live/Team4.png" alt=""></img>
