...
function ReportUser({ setReportPopup, openReportSelect, setOpenReportSelect }) {
  return (
    <div>
      <UserReportContainer>
        <TitleContainer>
        ...
        {openReportSelect.open ? (
          <SelectFullContainer>
            <SelectFullTop
              onClick={() =>
                setOpenReportSelect({ ...openReportSelect, open: false })
              }
              style={{ borderRadius: "6px 6px 0 0" }}
            >
              <SelectText>{openReportSelect.text}</SelectText>
              <img
            ...
            <SelectContentsWrapper>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "욕설" })
                }
              >
                욕설
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "거짓중계" })
                }
              >
                거짓중계
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "비매너" })
                }
              >
                비매너
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "도배" })
                }
              >
                도배
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "불법광고" })
                }
              >
                불법광고
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "관심끌기" })
                }
              >
                관심끌기
              </SelectContents>
              <SelectContents
                onClick={() =>
                  setOpenReportSelect({ open: false, text: "타회원비하" })
                }
              >
                타회원비하
              </SelectContents>
          ...
          <SelectDefault
            onClick={() =>
              setOpenReportSelect({ ...openReportSelect, open: true })
            }
          >
            <SelectText>{openReportSelect.text}</SelectText>
            <img
