        ...
        <>
          ...
          <NavigationContainer>
            ...
            <SpotsContainer>
              ...
              <MenuContents
                onClick={() => navigate("/score", { state: "soccer" })}
              >
                <img
                  src={"/images/main/Sports1.png"}
                  style={{
              ...
              <MenuContents
                onClick={() => navigate("/score", { state: "basketball" })}
              >
                <img
                  src={"/images/main/Sports2.png"}
                  style={{
              ...
              <MenuContents
                onClick={() => navigate("/score", { state: "baseball" })}
              >
                <img
                  src={"/images/main/Sports3.png"}
                  style={{
              ...
              <MenuContents
                onClick={() => navigate("/score", { state: "volleyball" })}
              >
                <img
                  src={"/images/main/Sports4.png"}
                  style={{
              ...
              <MenuContents
                onClick={() => navigate("/score", { state: "tennis" })}
              >
                <img
                  src={"/images/main/Sports5.png"}
