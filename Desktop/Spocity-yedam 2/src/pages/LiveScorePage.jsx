...
const NoBookMarkContainer = styled.div`
  width: 100%;
  height: 180px;
  margin-top: 1px;
  background-color: #303231;
  ...
  .noBookmarkBg {
    height: 180px;
    margin: 1px 16px 0 290px;
    padding: 78px 502px 77px 465px;
    object-fit: contain;
    background-color: #303231;
  }
`;
...
const BaseballQuarter = styled.div`
  margin-left: 126px;
  display: flex;
  align-items: center;
  div {
  ...
  return (
    <Wrapper>
      <ContentsContainer>
        ...
        <LiveComponent>
          ...
          {sportsType === "soccer" && (
            <LiveContents>
              ...
              tmpList.filter((arr) => {
                if (
                  arr.game.filter((gameArr) => {
                    return gameArr.bookmark === true;
                  }).length === 0
                ) {
                  return arr.bookmark === true;
                }
                return arr.bookmark === false;
              }).length === 0 ? (
                <>
                  <NoBookMarkContainer>
                    <img
                      className="alertStart"
                      src="/images/live/AlertStart.png"
                      alt=""
                    />
                    <img
                      className="noBookmarkText"
                      src="/images/live/NoBookmarkText.png"
                      alt=""
                    />
                  </NoBookMarkContainer>
                </>
                ...
                tmpList.map((item, index) => {
                  return (
                    <>
                      ...
                      {bookmark ? (
                        <>
                          {item.game.map((element, idx) => {
                            return (
                              <>
                                {isGameBookmark(item, element) ? (
                                  <LeagueInfoCotainer
                                    type="soccer"
                                    onClick={() =>
                                      element.type === "live" &&
                                      navigate("/live/soccer")
                                    }
                                  >
                                    <TimeContents>
                                      <Time>{element.time}</Time>
                                      <TimeRectangle type={element.type}>
                                        {element.type === "end"
                                          ? "경기종료"
                                          : element.type === "before"
                                          ? "경기전"
                                    ...
                                    <TeamContents>
                                      <Team1 goal={element?.left?.goal}>
                                        ...
                                        <img
                                          src={element?.left?.image}
                                          alt=""
                                        ></img>
                                      </Team1>
                                      <ScoreRectangle
                                        type={element?.score?.type}
                                        direction={element?.score?.direction}
                                      >
                                        {element?.score?.text}
                                          ...
                                          <ScorePopupStatsContainer>
                                            <ScorePopupStatsContents>
                                              <div className="propgress">
                                                ...
                                                <ProgressBar type="left">
                                                  <Progress width="51%"></Progress>
                                                </ProgressBar>
                                              </div>
                                              <div className="text">점유율</div>
                                              <div className="propgress">
                                                <ProgressBar>
                                                  <Progress width="51%"></Progress>
                                                </ProgressBar>
                                            ...
                                            <ScorePopupStatsContents>
                                              <div className="propgress">
                                                <span>41</span>
                                                <ProgressBar type="left">
                                                  <Progress width="41%"></Progress>
                                                </ProgressBar>
                                              </div>
                                              <div className="text">공격</div>
                                              <div className="propgress">
                                                <ProgressBar>
                                                  <Progress width="41%"></Progress>
                                                </ProgressBar>
                                            ...
                                            <ScorePopupStatsContents>
                                              <div className="propgress">
                                                <span>27</span>
                                                <ProgressBar type="left">
                                                  <Progress width="27%"></Progress>
                                                </ProgressBar>
                                              </div>
                                              <div className="text">슈팅</div>
                                              <div className="propgress">
                                                <ProgressBar>
                                                  <Progress width="27%"></Progress>
                                                </ProgressBar>
                                            ...
                                            <ScorePopupStatsContents>
                                              <div className="propgress">
                                                <span>36</span>
                                                <ProgressBar type="left">
                                                  <Progress width="36%"></Progress>
                                                </ProgressBar>
                                              </div>
                                              <div className="text">코너킥</div>
                                              <div className="propgress">
                                                <ProgressBar>
                                                  <Progress width="36%"></Progress>
                                                </ProgressBar>
                                    ...
                                    <OptionContents>
                                      ...
                                      <IconContents
                                        onClick={(e) => e.stopPropagation()}
                                      >
                                        {element?.icon?.youtube && (
                                          <img
                                            src="/images/main/Youtube.png"
                                            alt=""
                                          />
                                        )}
                                        {element?.icon?.uniform && (
                                          <img
                                        ...
                                        {element?.icon?.ground && (
                                          <img
                                            src="/images/main/Ground.png"
                                            alt=""
                                          />
                                        )}
                                        {tmpList[index].game[idx].bookmark ? (
                                          <img
                                            src="/images/live/Star-on.png"
                                            alt=""
                                            onClick={() =>
                                              changeGameBookmark(index, idx)
                                            }
                                          ></img>
                                        ) : (
                                          <img
                                ...
                                >
                                  ...
                                  <TeamContents>
                                    <Team1 goal={element?.left?.goal}>
                                      ...
                                      <TeamName>{element?.left?.name}</TeamName>
                                      <img
                                        src={element?.left?.image}
                                        alt=""
                                      ></img>
          ...
          {sportsType === "basketball" && (
            <LiveContents>
              <LeagueContainer>
                ...
                <BasketballQuarter>
                  <BasketballScoreContent>1Q</BasketballScoreContent>
                  <BasketballScoreContent>2Q</BasketballScoreContent>
                  <BasketballScoreContent>3Q</BasketballScoreContent>
                  <BasketballScoreContent>4Q</BasketballScoreContent>
                  <BasketballScoreContent>연장</BasketballScoreContent>
                </BasketballQuarter>
              </LeagueContainer>
              <LeagueInfoCotainer
                height="81px"
                onClick={() => navigate("/live/basketball")}
              >
                <BasketballTimeContents>
                  <Time>00:30</Time>
                  <BasketballTime>
                    <div>4Q</div>
                    <span>03:14</span>
                ...
                <TeamContents>
                  ...
                  <BasketballScoreContainer>
                    <BasketballScoreRectangle background="#19793a">
                      102
                    </BasketballScoreRectangle>
                    <BasketballScoreRectangle background="#daae00">
                      108
                    </BasketballScoreRectangle>
                  </BasketballScoreContainer>
                  <BasketballScore>
                ...
                <OptionContents>
                  <IconContents onClick={(e) => e.stopPropagation()}>
            ...
            <LiveContents>
              <LeagueContainer>
                ...
                <BaseballQuarter>
                  ...
                  <BasketballScoreContent>3</BasketballScoreContent>
                  <BasketballScoreContent>4</BasketballScoreContent>
                  <BasketballScoreContent>5</BasketballScoreContent>
                  <BasketballScoreContent>6</BasketballScoreContent>
                  <BasketballScoreContent>7</BasketballScoreContent>
                  <BasketballScoreContent>8</BasketballScoreContent>
                  <BasketballScoreContent>9</BasketballScoreContent>
                  <BasketballScoreContent>연장</BasketballScoreContent>
                </BaseballQuarter>
                <DividendText className="dividendText">해외배당</DividendText>
              </LeagueContainer>
              <LeagueInfoCotainer
                height="81px"
                onClick={() => navigate("/live/baseball")}
              >
                ...
                <OptionContents>
                  <IconContents onClick={(e) => e.stopPropagation()}>
                    <img src="/images/main/Youtube.png" alt="" />
                    <img src="/images/live/BaseballGround.png" alt="" />
                    <DividendContainer>
                      <DividendRectangle active={true}>4.38</DividendRectangle>
                      <DividendRectangle>3.09</DividendRectangle>
                    </DividendContainer>
                    <img src="/images/live/Star-off.png" alt="" />
                  </IconContents>
                </OptionContents>
          ...
          {sportsType === "volleyball" && (
            <LiveContents>
              <LeagueContainer>
                ...
                <img src="/images/live/Star-on.png" alt=""></img>
                <BaseballQuarter>
                  <BasketballScoreContent>S1</BasketballScoreContent>
                  <BasketballScoreContent>S2</BasketballScoreContent>
                  <BasketballScoreContent>S3</BasketballScoreContent>
                  <BasketballScoreContent>S4</BasketballScoreContent>
                  <BasketballScoreContent>S5</BasketballScoreContent>
                </BaseballQuarter>
                <DividendText className="dividendText">해외배당</DividendText>
              </LeagueContainer>
              <LeagueInfoCotainer
                height="81px"
                onClick={() => navigate("/live/volleyball")}
              >
                <BaseballTimeContents>
                  <Time>00:30</Time>
                ...
                <TeamContents>
                  ...
                  <AttackContainer>
                    <img src="/images/live/volleyball-blue.png" alt=""></img>
                  </AttackContainer>
                  <BasketballScore>
                    <div>
                      <BasketballScoreContent>2</BasketballScoreContent>
            ...
            <LiveContents>
              ...
              >
                ...
                <TeamContents>
                  ...
                  <BasketballScoreContainer>
                    <BaseballScoreRectangle background={true}>
                      1
                    </BaseballScoreRectangle>
                    <BaseballScoreRectangle active={true}>
                      4
                  ...
                  <TennisScoreContainer>
                    <TennisScore>0</TennisScore>
                    <TennisScore active={true}>5</TennisScore>
                  </TennisScoreContainer>
                </TeamContents>
                ...
                <OptionContents>
                  <IconContents onClick={(e) => e.stopPropagation()}>
                    <img src="/images/main/Youtube.png" alt="" />
                    <img src="/images/live/TennisGround.png" alt="" />
                    <DividendContainer>
                      <DividendRectangle active={true}>4.38</DividendRectangle>
                      <DividendRectangle>3.09</DividendRectangle>
                    </DividendContainer>
        ...
        <LiveMobile sportsType={sportsType}></LiveMobile>
