...
const MenuContainer = styled.div`
  ...
  @media (max-width: 720px) {
    ...
    margin-bottom: calc((41 / 1280) * 100vh);
    &::-webkit-scrollbar {
      display: none;
    }
  }
...
const NoLiveContainer = styled.div`
  width: 100%;
  height: 410px;
  margin-top: 1px;
  display: flex;
        ...
        <ListContainer>
          <div>
            {tmpList.length === 0 && (
              <NoLiveContainer>
                <img
                  src="/images/common/Tv.png"
                  alt="background"
                  className="tv"
                />
                <img
                  src="/images/common/NoLiveText.png"
                  alt="text"
                  className="noLiveText"
                />
              </NoLiveContainer>
            )}
            {tmpList.map((item, idx) => (
              <div key={idx} onClick={() => navigate("/live")}>
