    ...
    <Wrapper>
      ...
      tmpList.filter((arr) => {
        ...
        tmpList.map((item, index) => {
          if (tab === 4 && !isBookmark(item)) {
            return <></>;
          }
          return (
            <>
              <LeagueContainer open={item.open}>
                  ...
                  return (
                    <SoccerContainer>
                      <TeamContainer>
                        ...
                        ></img>
                        <TeamNameContainer>
                          <RankText className="rank">(1위)</RankText>
                      ...
                      <ScoreContainer
                        color={element.RightScoreStyle === "color"}
                        background={element.RightScoreStyle === "background"}
                      >
                        {element.RightScore}
                      </ScoreContainer>
                      <TeamContainer>
        ...
        <>
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(() => (
            <SoccerContainer>
              ...
              <GameInfoContainer>
                <BasketballGameTime>
                  <span className="quarter">4Q</span>
                  <span className="time">03:14</span>
                </BasketballGameTime>
                <span>05:10</span>
                <GameIconCantainer>
                  <img src="/images/main/Youtube.png" alt="" />
