...
const LiveScoreMobileFootball = ({ sportsType , liveCount , footballData , pageBasicImgUrl, tab , setTab , updateScore , nowTime}) => {
      ...
      <TopBarContainer>
          <div>
            <TabContainer>
              ...
              >
                라이브
                <TabCount>{footballData?.data_count}</TabCount>
              </Tab>
                  ...
                  >
                    <LeagueContainer>
                      ...
                      <SoccerContainer>
                        ...
                        <ScoreContainer className={data?.match_id === updateScore?.id ? (updateScore?.result[2][0] > updateScore?.result[3][0] ? "colorText" : "tie") :  (data.home_team_info.score >  data.away_team_info.score ? "colorText" : "tie")}
