...
const VideoContainer = styled.div`
  ...
  position: relative;
  background-image: url("/images/main/PopularLive.png");
...
const LiveBasketballMobile = ({ setMobileMenu, mobileMenu ,iframeData ,pageBasicImgUrl ,footballH2HData ,contentsTab ,setContentsTab}) => {
      ...
      <InfoContainer>
        <div className="bottom">
          <div className="top">
            <div>
              <span>3</span>
              <span className="text">작전타임</span>
            </div>
            <div>
              <span>2</span>
              <span className="text">파울</span>
            </div>
            <VerticalBar />
            <div>
              <span>3</span>
...
export default LiveBasketballMobile;
