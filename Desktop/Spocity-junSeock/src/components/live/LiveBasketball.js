...
import LiveBasketballMobile from "./LiveBasketballMobile";
import { DetailDataBasketball, IframeDataBasketball } from "../apis/api";
...
const LiveBasketball = ({
  ...
  useEffect(()=>{
    if( matchIdLocation.pathname.split("/")[4] !== ""){
      DetailDataBasketball(setFootballH2HData , matchIdLocation.pathname.split("/")[4])
    }
  },[])
  
  useEffect(()=>{
    if( matchIdLocation.pathname.split("/")[4] !== ""){
      IframeDataBasketball(setIframeData , matchIdLocation.pathname.split("/")[4])
    }
  },[])
          ...
          <>
            <InfoContainer>
              ...
              <div className="middle">
                ...
                <div>
                  <div>40</div>
                  <InfoBar type="left" width="40%">
                    <div></div>
                  </InfoBar>
                  <div className="shot">자유투</div>
                  <InfoBar type="right" width="38%">
                    <div></div>
                  </InfoBar>
                  <div>38</div>
                </div>
                    ...
                    <ScoreTbody item={item}>
                      <tr>
                        ...
                        {item.score.map((e, idx) => (
                          <td
                            className={item.activeScore === idx ? "active" : ""}
                          >
                            {e}
                          </td>
                        ))}
