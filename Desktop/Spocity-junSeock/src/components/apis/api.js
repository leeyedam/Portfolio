...
// axios
export const ScheduleDataSoccer = async (setState , cateGory, date , order , mouseEvent ) => {
    if(cateGory !== "live"){
...
// 농구 스케쥴 목록
export const ScheduleDataBasketball = async (setState , cateGory, date , order ) => {
    if(cateGory !== "live"){
        return await axios.get(process.env.REACT_APP_DB_HOST + `/api/main/basketball/match/schedule?category=${cateGory}&date=${date}&order=${order}` , {
            headers : {
                Authorization : getCookie('cityauth')
            }
        }).then(res=>{ 
        ...
        return await axios.get(process.env.REACT_APP_DB_HOST + `/api/main/basketball/match/schedule?category=${cateGory}&order=${order}` , {
            headers : {
                Authorization : getCookie('cityauth')
            }
        }).then(res=>{ 
...
// 농구 상세정보
export const DetailDataBasketball = async (setState , matchId ) => {
    return await axios.get(process.env.REACT_APP_DB_HOST + `/api/main/basketball/h2h/detail/${matchId}` , {
        headers : {
            Authorization : getCookie('cityauth')
        }
    }).then(res=>{ 
...
// 농구 전적 정보
export const IframeDataBasketball = async (setState , matchId ) => {
    return await axios.get(process.env.REACT_APP_DB_HOST + `/api/main/basketball/match/detail/${matchId}` , {
        headers : {
            Authorization : getCookie('cityauth')
        }
    }).then(res=>{ 
